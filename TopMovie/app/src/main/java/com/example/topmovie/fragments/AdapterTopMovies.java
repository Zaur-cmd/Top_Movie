...
public class AdapterTopMovies extends RecyclerView.Adapter<AdapterTopMovies.MovieViewHolder> {
    ...
    @NonNull
    @Override
    public AdapterTopMovies.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterTopMovies.MovieViewHolder holder, int position) {
